// ─── StudentProfileSheet ──────────────────────────────────────────────────────
// Reusable student profile side-sheet used in:
//   • StudentsPage   — full data from admin table
//   • BusDetailsModal — data enriched from mockStudents by name match
//
            ...
            <div>
              ...
              <div className="space-y-2">
                {student.attendance.slice(0, 5).map((r) => (
                  <div key={r.id} className="flex justify-between items-center text-xs bg-secondary/20 rounded-lg px-3 py-2">
