...
// ===== AUTH USERS — single source of truth for login =====
export interface AuthUser {
  id: string;
  name: string;
  email: string;
  password: string;       // plain-text for mock; hash in real app
...
export const mockAuthUsers: AuthUser[] = [
  ...
  },
  {
    ...
    phone: "01044445555",
    parentPhone: "01044440000",
    grade: "Grade 8",
  },
];

// ===== DRIVER PROFILES (derived from authUsers) =====
...
export const mockStudents: StudentProfile[] = [
  { id: "student-1", name: "Maya Johnson", email: "student@bustrack.io", phone: "01011112222", grade: "Grade 10", avatar: "https://i.pravatar.cc/150?img=48" },
  { id: "student-2", name: "Ali Hassan",   email: "ali.h@bustrack.io",   phone: "01022223333", grade: "Grade 9",  avatar: "https://i.pravatar.cc/150?img=68" },
  { id: "student-3", name: "Emma Davis",   email: "emma.d@bustrack.io",  phone: "01033334444", grade: "Grade 11", avatar: "https://i.pravatar.cc/150?img=45" },
  { id: "student-4", name: "Noah Smith",   email: "noah.s@bustrack.io",  phone: "01044445555", grade: "Grade 8",  avatar: "https://i.pravatar.cc/150?img=59" },
];
